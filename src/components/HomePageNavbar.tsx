    ...
    >
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between transition-colors duration-300 ">
        ...
        <div className="hidden lg:flex items-center space-x-6">
          {[
            { name: "Home", path: "/home" },
            { name: "Browse-Donations", path: "/browse-donations" },
            { name: "Browse-Needs", path: "/browse-requirements" },
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="bg-white text-gray-800 shadow-md mt-4 p-2">
              ...
              <DropdownMenuItem>
                <Link href="/create-donation" className="w-full hover:text-pink-500">
                  Create Donation
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <Link href="/create-requirement" className="w-full hover:text-pink-500">
                  Create Requirement
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <Link href="/transactions" className="w-full hover:text-pink-500">
                  My Transactions
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <Link href="/feedback" className="w-full hover:text-pink-500">
                  Feedback
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem>
          ...
          >
            {[
              ...
              <Link
                key={index}
                href={item.path}
                className="block py-2 hover:text-pink-500 w-full text-left"
                onClick={() => setIsMobileMenuOpen(false)}
                aria-label={`Navigate to ${item.name}`}
              >
                {item.name}
