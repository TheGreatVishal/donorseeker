		...
		<div className="flex flex-col items-center text-center overflow-hidden mt-10 pt-10">
				...
				<div className="container px-4 md:px-6 mx-auto max-w-7xl">
					...
					>
						{[
							...
							<motion.div key={index} variants={fadeIn} className="h-full">
								<Card className="h-full transition-all duration-300 ease-in-out hover:shadow-xl hover:-translate-y-2 border-t-4 border-t-sky-500 overflow-hidden">
			...
			<section className="w-full py-12 md:py-16 bg-white">
				<div className="container px-4 md:px-6 mx-auto max-w-7xl">
					...
					>
						{[
							{ label: "Registered Users", value: "5,000+", icon: Users },
							{ label: "Donations Completed", value: "12,500+", icon: Gift },
							{ label: "Positive Ratings", value: "98%", icon: ThumbsUp },
							{ label: "Communities Served", value: "250+", icon: Heart },
						].map((stat, index) => (
							<motion.div key={index} className="flex flex-col items-center space-y-2" variants={fadeIn}>
